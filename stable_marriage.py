...
class Serenader:
    ...
    def is_fulfilled(self):
        ...
        # since if there were serenadees that prefer `self` over their current serenaders,
        # the matching could be unstable since they could have been matched to `self`.
